...
public class RoomService implements IRoomService {
    ...
    public List<Room> getAvailableRooms(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        List<Room> availableRooms = roomRepository.findAvailableRoomsByDatesAndType(checkInDate, checkOutDate,
                roomType);
        // Assuming user wants unique room types. Filter duplicates based on roomType.
        // This is a simple in-memory distinction. Ideally, query should distinct.
        // But since we need Room entity fields, we just pick the first room of each
        // type.
        return availableRooms.stream()
                .filter(room -> room.getRoomType() != null)
                // Use a map to filter by unique roomType
