                    ...
                    <tbody>
                      {bookings.map((booking, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            {Array.isArray(booking.checkInDate)
                              ? moment([booking.checkInDate[0], booking.checkInDate[1] - 1, booking.checkInDate[2]]).format("MMM Do, YYYY")
                              : moment(booking.checkInDate).format("MMM Do, YYYY")}
                          </td>
                          <td>
                            {Array.isArray(booking.checkOutDate)
                              ? moment([booking.checkOutDate[0], booking.checkOutDate[1] - 1, booking.checkOutDate[2]]).format("MMM Do, YYYY")
